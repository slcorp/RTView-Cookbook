...
*How to*
1. Create a composite object  as a separate .rtv file named myComposite.rtv. This composite object will later be instanced into pattern4.rtv
